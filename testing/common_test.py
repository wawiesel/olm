...
def test_get_function_handle():
    ...
    _type = "scale.olm.generate:comp_uo2_simple"
    data = {"state": {"enrichment": 5.0}}
    comp = common.get_function_handle(_type)(**data)
    x = comp["uo2"]["iso"]
...
def test_single_nuclide_default_molar_mass():
    ...
    iso_wts = {"am241": 100.0}
    result = common.grams_per_mol(iso_wts)
...
def test_empty_input_dictionary():
    ...
    iso_wts = {}
    result = common.grams_per_mol({"u235": 0.999, "xxx0": 0.001}, {})
