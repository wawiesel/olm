...
class ScaleRte:
    ...
    def _hash_file(file: str) -> str:
        ...
        Returns:
            Hash in hex of the contents of the file.
        """
        from imohash import hashfile

        return str(hashfile(file, hexdigest=True))
    ...
    def _determine_if_rerun(output_file, input_file, data_size, version):
        ...
        to rerun SCALE. Based on the internal convention that this ScaleRte wrapper
